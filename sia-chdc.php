...
function my_scripts_method() {
	$script_url = plugins_url( 'js/jquery.hideseek.min.js', __FILE__ );
	wp_register_script('sia_hideseek', $script_url, array('jquery') );
}
...
function sia_schdc()
{
    wp_enqueue_script('sia_hideseek');
...
?>
    <div id="sia-dictionar">
        <div>
            ...
            ?>
                <br />
                <input id="search" type="search" name="search" placeholder="Поиск..." type="text" data-list=".list"><input type="button" class="clear-search" value="X">
            <?php }
            ?>
            <ul class="list">
                <?php
